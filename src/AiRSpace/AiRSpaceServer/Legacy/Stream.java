...
package AiRSpace.AiRSpaceServer.Legacy;
...
public class Stream
{
    ...
    {
        int packetId = id + packetEncryption.getNextKey();
        buffer[currentOffset++] = (byte) packetId;
    }
    ...
    { // creates a variable sized mainFrame
    ...
    {// ends a variable sized mainFrame
        if (frameStackPtr < 0) {
